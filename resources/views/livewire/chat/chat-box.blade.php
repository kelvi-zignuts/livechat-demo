        ...
        <div @class([ 'max-w-[85%] md:max-w-[78%] flex w-auto gap-2 relative mt-2' , ])>
            ...
            <div @class(['flex flex-wrap text-[15px] rounded-xl p-2.5 flex flex-col text-black
                ...
                <p class="whitespace-normal truncate text-sm md:text-base tracking-wide lg:tracking-normal">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo, quae a magnam quibusdam
                    voluptates ex eligendi quod odio beatae, aspernatur reiciendis, dignissimos perferendis
                    repellendus expedita optio tempore illum assumenda voluptatem.
                </p>
